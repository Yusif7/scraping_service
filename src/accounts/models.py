...
class MyUser(AbstractBaseUser):
    ...
    # We use set_null if user do not add a city to registration form , we add it to base like empty
    ...
    # If want to add podpisku na email
    sendEmail = models.BooleanField(default=True)
    # We copy name of MyUserManager class add in objects
